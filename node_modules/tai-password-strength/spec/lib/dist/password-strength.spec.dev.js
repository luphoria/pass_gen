...
describe("addCommonPasswords()", function () {
  it("adds data as JSON then passes nothing to reset", function () {
    passwordStrength.addCommonPasswords(["abc123", "123456"]);
    expect(passwordStrength.commonPasswords).toEqual(["abc123", "123456"]);
...
describe("check()", function () {
  beforeEach(function () {
    passwordStrength.addCommonPasswords(["abc123", "abcd1234", "quote"]).addTrigraphMap({
      _qu: 9468,
      quo: 267,
      uot: 2820,
      te_: 1678
...
describe("checkCommonPasswords()", function () {
  describe("with some common passwords", function () {
    beforeEach(function () {
      passwordStrength.addCommonPasswords(["abc123", "!helpme"]);
    });
