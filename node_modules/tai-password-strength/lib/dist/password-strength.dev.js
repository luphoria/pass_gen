 ...
 */
"use strict"; // fid-umd {"name":"PasswordStrength"}
...
(function (name, root, factory) {
  ...
  if ((typeof module === "undefined" ? "undefined" : _typeof(module))[0] === "o" && isObject(module.exports)) {
    module.exports = factory();
  } else if ((typeof exports === "undefined" ? "undefined" : _typeof(exports))[0] === "o") {
...
})("PasswordStrength", void 0, function () {
  // fid-umd end
  ...
  function PasswordStrength() {
    ...
    this.addTrigraphMap = function (trigraphMap) {
      if (trigraphMap) {
        if (trigraphMap && _typeof(trigraphMap) === "object" && !Array.isArray(trigraphMap)) {
    ...
    */
    ...
    this.shannonScore = function (pass) {
      ...
      function countFrequencies() {
        var c, h, i; // Hash for collecting frequencies
  ...
  return PasswordStrength; // fid-umd post
}); // fid-umd post-end